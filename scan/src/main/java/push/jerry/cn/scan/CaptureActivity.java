...
public abstract class CaptureActivity extends AppCompatActivity
    ...
    private void requestPermission(SurfaceHolder surfaceHolder) {
        this.surfaceHolder = surfaceHolder;
        if (PackageManager.PERMISSION_GRANTED ==
                ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)) {
            initCamera(surfaceHolder);
        } else if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)){
            Toast.makeText(this, "扫一扫功能需要开启摄像头权限，请到权限管理界面设置。", Toast.LENGTH_SHORT).show();
        } else {
...
//        animSet.start();
    ...
    protected abstract void doAnalysisResult(String result);
    ...
    public void onBackPressed() {
        super.onBackPressed();
//        Utils.dismissRevealAnim(clickView, flMain, Build.VERSION.SDK_INT);
    }
}
